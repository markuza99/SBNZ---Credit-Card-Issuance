...
public class BankService {
	...
	@Autowired
	public BankService(KieContainer kieContainer, UserRepository userRepository, CreditCardRepository creditCardRepository) {
...
//		System.out.println("RANDOM VREDNOST JE " + randomValue);
//		kieSession.insert(new TransactionComplexEvent(1l,2l, randomValue));
//		kieSession.insert(u.getCreditCard());
//		kieSession.fireAllRules();
		return "Card created!";
	}
	...
	private String compileTemplate(BankTemplate bt, String rule){ 
        ...
        try (InputStream inputStream = new FileInputStream("../drools-spring-kjar/src/main/resources/sbnz/integracija/templates/"+rule)) {
